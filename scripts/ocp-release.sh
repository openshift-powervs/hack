...
MCO_IMAGE=${MCO_IMAGE:-quay.io/powercloud/ose-machine-config-operator@sha256:685aa4e4cd77ba325cc361f868b804f4fbf561b5b4385cbb0ee7dd01d2cc1756}

oc adm release new --max-per-registry=${MAX_PER_REGISTRY} --allow-missing-images --insecure -a ~/pull_secret.json \
--from-release=${FROM_RELEASE} \
--to-image=localhost:5000/${TO_IMAGE} \
machine-config-operator=${MCO_IMAGE} \
machine-api-operator=quay.io/psundara/ose-machine-api-operator@sha256:ab24a19ff29f72364041d40af75afc3f010cb2402e0b87949884b9804fab1bf3

#machine-api-operator=quay.io/powercloud/machine-api-operator@sha256:6015d050ad6b5be4f4ab66833ee59d40fb17b9ac7033551c72a93d6d7d2991f0
...
# or look for the newest img at https://quay.io/repository/powercloud/openshift-release?tab=tags
echo "${TO_IMAGE_REGISTRY}/${TO_IMAGE}" > latest_release_img
